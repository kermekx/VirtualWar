			...
			cellule.addMouseListener(new MouseListener() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					case "base":
						...
						Robot[] robot = new Robot[vue.getBase(vue.getEquipe()).getUnites().size()];
						for (int i = 0; i < robot.length; i++)
							robot[i] = vue.getBase(vue.getEquipe()).getUnites().get(i);
						
						final JComboBox<Robot> boxRobot = new JComboBox<Robot>(robot);
